...
* La fecha límite para la entrega del RFP será el: *22 de mayo de 2024*
* Se deberá realizar una presentación el mismo día *22 de mayo de 2024* en el horario habitual de la asignatura (Requisitos en la sección: *Respuestas a este RFP*)
...
| Tema                             | Puntuación |
| -------------------------------- | ---------: |
| Sistema funcionando en AWS       |         15 |
| Revisión de preguntas anteriores |          5 |
| Sistema de métricas/logs         |          5 |
| Costes y entornos                |         10 |
| Presentación/Demo                |         15 |
| Total                            |         50 |

## Modificaciones sobre este RFI

El cliente se guarda el derecho a modificar este RFI en cualquier momento, siendo obligado su aviso mediante anuncio en miAulario o e-mail a partir del día 9 de mayo del 2024.
