...
* 18 [Integración Continua](teoria/Mejora-Continua.md) -- [*diapositivas*](pdf/Mejora-Continua.pdf)
* 18 *Trabajo Libre: Apigateway + Flujo CI automático*
* 25 __Evaluación [RFI I](RFI/RFI-I.md)__
* 25 __Explicación [RFI II](RFI/RFI-II.md)__

## Marzo

* 4 [Cloud Computing](teoria/Cloud.md). -- [diapositivas](pdf/Cloud.pdf)
* 4 [CPD VS Cloud](pdf/Cloud%20Computing.pptx.pdf)
* 4 *Trabajo Libre: Flujo CI automático y Creación API*
* 11 [Arquitecturas de servicios en la nube.](teoria/Arquitecturas-nube.md) - [diapositivas](pdf/Arquitecturas-nube.pdf)
* 11 Introducción a AWS. (revisión en directo de como se usa el panel de AWS)
* 11 *Trabajo Libre: Trabajo en API, Flujo CI*
* 18 [Orquestación de contenedores](pdf/Orquestación%20de%20Contenedores.pdf)
...
* 22 Resolución de dudas + Trabajo Libre en RFP
* 29 [Entornos y costes](teoria/Entornos-y-Costes.md) -- [diapositivas](pdf/Entornos-y-Costes.pdf)
* 29 Revisión práctica de como ver los costes en AWS 
* 29 *Trabajo Libre*. en RFP

## Mayo

* 6 *Trabajo Libre* en RFP
* 13 __Evaluación [RFP](RFI/RFP.md)__
* 20 Revisión de la asignatura + Preparación de examen.
* 27 Evaluación Ordinaria
